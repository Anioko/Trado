...
from wtforms.validators import Length, ValidationError, InputRequired, Email, Optional
...
class EventForm(FlaskForm):
    ...
    event_country = SelectField(u'Select Country', choices=[('Afganistan', 'Afghanistan'),
                                                               ('Albania', 'Albania'),
                                                               ('Algeria', 'Algeria'),
    ...
    logo = FileField('Event logo or Picture', validators=[Optional(), FileAllowed(images, 'Images only!')])
