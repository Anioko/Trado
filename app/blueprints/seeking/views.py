...
def added_preference(id, username):
    ...
    return render_template(
        'seeking/added_preference.html', data=data, id=id, username=username, user=user)
...
def add_preference(id, username):
    ...
    if current_user.id != id and current_user.username != username:
        return redirect(url_for('seeking.add_preference', id=current_user.id, username=current_user.username))
    ...
    return render_template('seeking/add_preference.html', form=form, data=data, id=id)
...
def edit(id, username):
    ...
    return render_template('seeking/add_preference.html', form=form, id=id, username=username)
