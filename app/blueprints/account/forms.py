...
class UpdateDetailsForm(FlaskForm):
    ...
    last_name = StringField('Last name',
                            validators=[InputRequired(),
                                        Length(1, 64)])
    height = SelectField(' Your height ',
                         choices=[('4 feet', '4 feet'),
                                  ...
                                  ('8 feet', '8 feet')])
    seeking_partner = SelectField('Gender Preference', choices=[
                                  ('Male', 'Male'), ('Female', 'Female')])
    age = SelectField(u'Select Age',
                      choices=[('18', '18'), ('19', '19'), ('20', '20'),
                               ('21', '21'), ('22', '22'), ('23', '23'),
    ...
    state = StringField('Your State',
                        validators=[InputRequired(),
                                    Length(1, 64)])

    country = SelectField(
        u'Select Country',
        choices=[('Afganistan', 'Afghanistan'), ('Albania', 'Albania'),
                 ...
                 ('Bolivia', 'Bolivia'), ('Bonaire', 'Bonaire'),
                 ...
                 ('Canada', 'Canada'), ('Canary Islands', 'Canary Islands'),
                 ('Cape Verde', 'Cape Verde'),
                 ('Cayman Islands', 'Cayman Islands'),
                 ('Central African Republic', 'Central African Republic'),
                 ('Chad', 'Chad'), ('Channel Islands', 'Channel Islands'),
                 ('Chile', 'Chile'), ('China', 'China'),
                 ('Christmas Island', 'Christmas Island'),
                 ('Cocos Island', 'Cocos Island'), ('Colombia', 'Colombia'),
                 ('Comoros', 'Comoros'), ('Congo', 'Congo'),
                 ('Cook Islands', 'Cook Islands'), ('Costa Rica',
                                                    'Costa Rica'),
                 ('Cote DIvoire', 'Cote DIvoire'), ('Croatia', 'Croatia'),
                 ('Cuba', 'Cuba'), ('Curaco', 'Curacao'), ('Cyprus', 'Cyprus'),
                 ...
                 ('Great Britain', 'Great Britain'), ('Greece', 'Greece'),
                 ...
                 ('Korea North', 'Korea North'), ('Korea Sout', 'Korea South'),
                 ...
                 ('Palau Island', 'Palau Island'), ('Palestine', 'Palestine'),
                 ('Panama', 'Panama'),
                 ('Papua New Guinea', 'Papua New Guinea'),
                 ('Paraguay', 'Paraguay'), ('Peru', 'Peru'),
                 ('Phillipines', 'Philippines'),
                 ('Pitcairn Island', 'Pitcairn Island'), ('Poland', 'Poland'),
                 ...
                 ('St Eustatius', 'St Eustatius'), ('St Helena', 'St Helena'),
                 ('St Kitts-Nevis', 'St Kitts-Nevis'),
                 ('St Lucia', 'St Lucia'), ('St Maarten', 'St Maarten'),
                 ('St Pierre & Miquelon', 'St Pierre & Miquelon'),
                 ('St Vincent & Grenadines', 'St Vincent & Grenadines'),
                 ('Saipan', 'Saipan'), ('Samoa', 'Samoa'),
                 ...
                 ('Uraguay', 'Uruguay'), ('Uzbekistan', 'Uzbekistan'),
                 ('Vanuatu', 'Vanuatu'),
                 ...
                 ('Yemen', 'Yemen'), ('Zaire', 'Zaire'), ('Zambia', 'Zambia'),
                 ('Zimbabwe', 'Zimbabwe')])

    religion = SelectField(' Select your religion',
                           choices=[('Christianity', 'Christianity'),
                                    ('Judaism', 'Judaism'), ('Islam', 'Islam'),
                                    ('Hinduism', 'Hinduism'), ('None', 'None'),
                                    ('Others', 'Others')])

    ethnicity = SelectField(' Select your ethnicity',
                            choices=[('African American', 'African American'),
                                     ('Caucasian', 'Caucasian'),
                                     ('European', 'European'),
                                     ('Hispanic', 'Hispanic'),
                                     ('Indian', 'Indian'),
    ...
    marital_type = SelectField(' Relationship Preference',
                               choices=[('Monogamy', 'Monogamy'),
                                        ('Polygamy', 'Polygamy'),
                                        ('Both Polygamy or Monogamy',
                                         'Both Polygamy or Monogamy')])

    body_type = SelectField(' Select Body type',
                            choices=[
                                ('Slender', 'Slender'),
                                ('Athletic', 'Athletic'),
                                ('Average', 'Average'),
    ...
    church_denomination = SelectField(
        ' Select Christian Denomination',
        choices=[('7th Day Adventist', '7th Day Adventist'),
                 ('Anglican', 'Anglican'),
                 ('Apostolic Assembly of God', 'Apostolic Assembly of God'),
                 ('Baptist', 'Baptist'), ('Catholic', 'Catholic'),
                 ...
                 ('Lutheran', 'Lutheran'), ('Mennonite', 'Mennonite'),
                 ('Messianic', 'Messianic'), ('Methodist', 'Methodist'),
                 ('Missionary Alliance', 'Missionary Alliance'),
                 ('Nazarene', 'Nazarene'),
                 ('Non-Denominational', 'Non-Denominational'),
                 ('Orthodox', 'Orthodox'), ('Pentecostal', 'Pentecostal'),
                 ('Presbyterian', 'Presbyterian'),
                 ('Protestant', 'Protestant'), ('Reformed', 'Reformed'),
                 ('Southern Baptist', 'Southern Baptist'),
                 ('United', 'United'),
                 ('United Pentecostal Church', 'United Pentecostal Church'),
                 ('Jehovah Withness', 'Jehovah Withness'), ('Other', 'Other')])
    ...
    drinking_status = SelectField(' Do you drink?',
                                  choices=[('No', 'No'),
                                           ('Socially', 'Socially'),
    ...
    smoking_status = SelectField(' Do you smoke?',
                                 choices=[('No', 'No'),
                                          ('Socially', 'Socially'),
                                          ('Ocassionally', 'Ocassionally'),
                                          ('Frequently', 'Frequently'),
    ...
    education_level = SelectField(
        'Education Level',
        choices=[
            ('Some School', 'Some School'), ('GED', 'GED'),
    ...
    has_children = SelectField(' Do you have kids?',
                               choices=[('Yes', 'Yes'),
                                        ('Yes but all grown',
                                         'Yes but all grown'), ('No', 'No')])

    want_children = SelectField(' Do you want kids?',
                                choices=[('Yes', 'Yes'),
                                         ('Does Not Want Children',
                                          'Does Not Want Children'),
                                         ('Undecided/Open', 'Undecided/Open')])

    open_for_relocation = SelectField(' Would you be willing to relocate ?',
                                      choices=[('Yes', 'Yes'),
                                               ('Maybe ', 'Maybe'),
                                               ('No', 'No')])
