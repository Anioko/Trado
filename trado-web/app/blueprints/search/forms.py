...
class SeekingForm(BaseModelForm):
    ...
    seeking_partner = SelectField(' type of partner',
                                  choices=[('A Date', 'A Date'),
                                           ('A Marriage Partner',
                                            'A Marriage Partner'),
                                           ('Open to Chat', 'Open to Chat'),
                                           ('Live together', 'Live together')])

    seeking_from_height = SelectField(
        ' From ',
        choices=[
            ('4 feet', '4 feet'), ('4 feet 1 inches', '4 feet 1 inches'),
            ...
            ('4 feet 11 inches', '4 feet 11 inches'), ('5 feet', '5 feet'),
            ...
            ('5 feet 11 inches', '5 feet 11 inches'), ('6 feet', '6 feet'),
            ...
            ('6 feet 11 inches', '6 feet 11 inches'), ('7 feet', '7 feet'),
            ...
            ('7 feet 11 inches', '7 feet 11 inches'), ('8 feet', '8 feet')
        ])

    seeking_to_height = SelectField(
        ' to height ',
        choices=[
            ('4 feet', '4 feet'), ('4 feet 1 inches', '4 feet 1 inches'),
            ('4 feet 2 inches', '4 feet 2 inches'),
    ...
    seeking_sex = SelectField(' Looking for',
                              choices=[('Female', 'Female'), ('Male', 'Male')])

    seeking_from_age = SelectField(u'From age',
                                   choices=[('18', '18'), ('19', '19'),
                                            ('20', '20'), ('21', '21'),
                                            ('22', '22'), ('23', '23'),
                                            ('24', '24'), ('25', '25'),
    ...
    seeking_to_age = SelectField(u'To Age',
                                 choices=[('18', '18'), ('19', '19'),
                                          ('20', '20'), ('21', '21'),
                                          ('22', '22'), ('23', '23'),
                                          ('24', '24'), ('25', '25'),
    ...
    seeking_religion_one = SelectField(' Religion choice one',
                                       choices=[('Christianity',
                                                 'Christianity'),
                                                ('Judaism', 'Judaism'),
                                                ('Islam', 'Islam'),
                                                ('Hinduism', 'Hinduism'),
    ...
    seeking_religion_two = SelectField(' Religion choice two',
                                       choices=[('Christianity',
                                                 'Christianity'),
                                                ('Judaism', 'Judaism'),
                                                ('Islam', 'Islam'),
    ...
    seeking_religion_three = SelectField(' Religion choice three',
                                         choices=[('Christianity',
                                                   'Christianity'),
                                                  ('Judaism', 'Judaism'),
                                                  ('Islam', 'Islam'),
    ...
    seeking_ethnicity_one = SelectField(
        ' Seeking Ethnicity option one',
        choices=[('African American', 'African American'),
                 ('Caucasian', 'Caucasian'), ('European', 'European'),
                 ('Hispanic', 'Hispanic'), ('Indian', 'Indian'),
                 ...
                 ('Caribbean', 'Caribbean'), ('Mixed Race', 'Mixed Race'),
                 ('Other Ethnicity', 'Other Ethnicity')])

    seeking_ethnicity_two = SelectField(
        ' Seeking Ethnicity option two',
        choices=[('African American', 'African American'),
                 ('Caucasian', 'Caucasian'), ('European', 'European'),
                 ('Hispanic', 'Hispanic'), ('Indian', 'Indian'),
                 ('Middle Eastern', 'Middle Eastern'), ('African', 'African'),
                 ...
                 ('Caribbean', 'Caribbean'), ('Mixed Race', 'Mixed Race'),
                 ('Other Ethnicity', 'Other Ethnicity')])
    seeking_ethnicity_three = SelectField(
        ' Seeking Ethnicity option three',
        choices=[('African American', 'African American'),
                 ('Caucasian', 'Caucasian'), ('European', 'European'),
                 ('Hispanic', 'Hispanic'), ('Indian', 'Indian'),
                 ('Middle Eastern', 'Middle Eastern'), ('African', 'African'),
    ...
    seeking_ethnicity_four = SelectField(
        ' Seeking Ethnicity option four',
        choices=[('African American', 'African American'),
                 ('Caucasian', 'Caucasian'), ('European', 'European'),
                 ('Hispanic', 'Hispanic'), ('Indian', 'Indian'),
                 ('Middle Eastern', 'Middle Eastern'), ('African', 'African'),
    ...
    seeking_ethnicity_five = SelectField(
        ' Seeking Ethnicity option five',
        choices=[('African American', 'African American'),
                 ('Caucasian', 'Caucasian'), ('European', 'European'),
                 ('Hispanic', 'Hispanic'), ('Indian', 'Indian'),
                 ('Middle Eastern', 'Middle Eastern'), ('African', 'African'),
    ...
    seeking_marital_type_one = SelectField(
        ' Seeking relationship preference option one',
        choices=[('Monogamy', 'Monogamy'), ('Polygamy', 'Polygamy'),
                 ('Both Polygamy or Monogamy', 'Both Polygamy or Monogamy')])

    seeking_body_type_one = SelectField(
        ' Seeking body type option one',
        choices=[('Slender', 'Slender'), ('Athletic', 'Athletic'),
                 ('Average', 'Average'),
                 ('A Few Extra Pounds', 'A Few Extra Pounds'),
                 ('Big & Tall/BBW', 'Big & Tall/BBW'),
                 ('Muscular', 'Muscular'), ('Voluptuous', 'Voluptuous'),
                 ('Petite', 'Petite'),
                 ('Well Proportioned', 'Well Proportioned'),
                 ('Curvy/Curvaceous', 'Curvy/Curvaceous')])

    seeking_body_type_two = SelectField(
        ' Seeking body type option two',
        choices=[('Slender', 'Slender'), ('Athletic', 'Athletic'),
                 ('Average', 'Average'),
                 ('A Few Extra Pounds', 'A Few Extra Pounds'),
                 ('Big & Tall/BBW', 'Big & Tall/BBW'),
    ...
    seeking_body_type_three = SelectField(
        ' Seeking body type option three',
        choices=[('Slender', 'Slender'), ('Athletic', 'Athletic'),
                 ('Average', 'Average'),
                 ('A Few Extra Pounds', 'A Few Extra Pounds'),
                 ('Big & Tall/BBW', 'Big & Tall/BBW'),
    ...
    seeking_body_type_four = SelectField(
        ' Seeking body type option four',
        choices=[('Slender', 'Slender'), ('Athletic', 'Athletic'),
                 ('Average', 'Average'),
                 ('A Few Extra Pounds', 'A Few Extra Pounds'),
                 ('Big & Tall/BBW', 'Big & Tall/BBW'),
    ...
    seeking_church_denomination_one = SelectField(
        ' Seeking Christian denomination one',
    ...
    seeking_church_denomination_two = SelectField(
        ' Seeking Christian denomination two',
        choices=[('7th Day Adventist', '7th Day Adventist'),
                 ('Anglican', 'Anglican'),
                 ('Apostolic Assembly of God', 'Apostolic Assembly of God'),
                 ('Baptist', 'Baptist'), ('Catholic', 'Catholic'),
    ...
    seeking_church_denomination_three = SelectField(
        ' Seeking Christian denomination three',
        choices=[('7th Day Adventist', '7th Day Adventist'),
                 ('Anglican', 'Anglican'),
                 ('Apostolic Assembly of God', 'Apostolic Assembly of God'),
                 ('Baptist', 'Baptist'), ('Catholic', 'Catholic'),
    ...
    seeking_church_denomination_four = SelectField(
        ' Seeking Christian denomination four',
        choices=[('7th Day Adventist', '7th Day Adventist'),
                 ('Anglican', 'Anglican'),
                 ('Apostolic Assembly of God', 'Apostolic Assembly of God'),
                 ('Baptist', 'Baptist'), ('Catholic', 'Catholic'),
    ...
    seeking_church_denomination_five = SelectField(
        ' Seeking Christian denomination five',
        choices=[('7th Day Adventist', '7th Day Adventist'),
                 ('Anglican', 'Anglican'),
                 ('Apostolic Assembly of God', 'Apostolic Assembly of God'),
                 ('Baptist', 'Baptist'), ('Catholic', 'Catholic'),
    ...
    seeking_church_denomination_six = SelectField(
        ' Seeking Christian denomination six',
        choices=[('7th Day Adventist', '7th Day Adventist'),
                 ('Anglican', 'Anglican'),
                 ('Apostolic Assembly of God', 'Apostolic Assembly of God'),
                 ('Baptist', 'Baptist'), ('Catholic', 'Catholic'),
    ...
    seeking_current_status_three = SelectField(
        ' Seeking current status option three',
        choices=[('Married', 'Married'), ('Seperated', 'Seperated'),
                 ('Single', 'Single'),
                 ('Single but in a relationship',
                  'Single but in a relationship'), ('Widowed', 'Widowed')])

    seeking_drinking_status_one = SelectField(' drinking status option one',
                                              choices=[
                                                  ('No', 'No'),
                                                  ('Socially', 'Socially'),
                                                  ('Ocassionally',
    ...
    seeking_drinking_status_two = SelectField(' drinking status option two',
                                              choices=[
                                                  ('No', 'No'),
                                                  ('Socially', 'Socially'),
                                                  ('Ocassionally',
    ...
    seeking_smoking_status_one = SelectField(' smoking status option one',
                                             choices=[('No', 'No'),
                                                      ('Socially', 'Socially'),
                                                      ('Ocassionally',
                                                       'Ocassionally'),
    ...
    seeking_smoking_status_two = SelectField(' smoking status option two',
                                             choices=[('No', 'No'),
                                                      ('Socially', 'Socially'),
                                                      ('Ocassionally',
                                                       'Ocassionally'),
    ...
    seeking_education_level_one = SelectField(
        'Education level option one',
        choices=[
    ...
    seeking_education_level_two = SelectField(
        'Education level option two',
        choices=[
            ('Some School', 'Some School'), ('GED', 'GED'),
            ('High School Graduate', 'High School Graduate'),
            ('Specialty/Trade School', 'Specialty/Trade School'),
    ...
    seeking_education_level_three = SelectField(
        'Education level option three',
        choices=[
            ('Some School', 'Some School'), ('GED', 'GED'),
            ('High School Graduate', 'High School Graduate'),
            ('Specialty/Trade School', 'Specialty/Trade School'),
    ...
    seeking_education_level_four = SelectField(
        'Education level option four',
        choices=[
            ('Some School', 'Some School'), ('GED', 'GED'),
            ('High School Graduate', 'High School Graduate'),
            ('Specialty/Trade School', 'Specialty/Trade School'),
    ...
    seeking_education_level_five = SelectField(
        'Education level option five',
        choices=[
            ('Some School', 'Some School'), ('GED', 'GED'),
            ('High School Graduate', 'High School Graduate'),
            ('Specialty/Trade School', 'Specialty/Trade School'),
    ...
    seeking_education_level_six = SelectField(
        'Education level option six',
        choices=[
            ('Some School', 'Some School'), ('GED', 'GED'),
            ('High School Graduate', 'High School Graduate'),
            ('Specialty/Trade School', 'Specialty/Trade School'),
    ...
    seeking_education_level_seven = SelectField(
        'Education level option seven',
        choices=[
            ('Some School', 'Some School'), ('GED', 'GED'),
            ('High School Graduate', 'High School Graduate'),
            ('Specialty/Trade School', 'Specialty/Trade School'),
    ...
    seeking_education_level_eight = SelectField(
        'Education level option eight',
        choices=[
            ('Some School', 'Some School'), ('GED', 'GED'),
            ('High School Graduate', 'High School Graduate'),
            ('Specialty/Trade School', 'Specialty/Trade School'),
    ...
    seeking_education_level_nine = SelectField(
        'Education level option nine',
        choices=[
            ('Some School', 'Some School'), ('GED', 'GED'),
            ('High School Graduate', 'High School Graduate'),
            ('Specialty/Trade School', 'Specialty/Trade School'),
    ...
    seeking_has_children_one = SelectField(' has kids option one',
                                           choices=[('Yes', 'Yes'),
                                                    ('Yes but all grown',
                                                     'Yes but all grown'),
                                                    ('No', 'No')])

    seeking_has_children_two = SelectField(' has kids option two',
                                           choices=[('Yes', 'Yes'),
                                                    ('Yes but all grown',
                                                     'Yes but all grown'),
                                                    ('No', 'No')])

    seeking_has_children_three = SelectField(' has kids option three',
                                             choices=[('Yes', 'Yes'),
                                                      ('Yes but all grown',
                                                       'Yes but all grown'),
                                                      ('No', 'No')])

    seeking_want_children_one = SelectField(' want kids option one',
                                            choices=[('Yes', 'Yes'),
                                                     ('Yes but all grown',
                                                      'Yes but all grown'),
                                                     ('No', 'No')])

    seeking_want_children_two = SelectField(' want kids option two',
                                            choices=[('Yes', 'Yes'),
                                                     ('Yes but all grown',
                                                      'Yes but all grown'),
                                                     ('No', 'No')])

    seeking_want_children_three = SelectField(' want kids option three',
                                              choices=[('Yes', 'Yes'),
                                                       ('Yes but all grown',
                                                        'Yes but all grown'),
                                                       ('No', 'No')])

    seeking_open_for_relocation = SelectField(' relocation option',
                                              choices=[('Yes', 'Yes'),
                                                       ('Maybe ', 'Maybe'),
                                                       ('No', 'No')])

    seeking_country_one = SelectField(
        u'Select Country',
    ...
    seeking_country_two = SelectField(
        u'Select Country',
        choices=[('Afganistan', 'Afghanistan'), ('Albania', 'Albania'),
                 ('Algeria', 'Algeria'), ('American Samoa', 'American Samoa'),
                 ('Andorra', 'Andorra'), ('Angola', 'Angola'),
    ...
    seeking_country_three = SelectField(
        u'Select Country',
        choices=[('Afganistan', 'Afghanistan'), ('Albania', 'Albania'),
                 ('Algeria', 'Algeria'), ('American Samoa', 'American Samoa'),
                 ('Andorra', 'Andorra'), ('Angola', 'Angola'),
    ...
    seeking_country_four = SelectField(
        u'Select Country',
        choices=[('Afganistan', 'Afghanistan'), ('Albania', 'Albania'),
                 ('Algeria', 'Algeria'), ('American Samoa', 'American Samoa'),
                 ('Andorra', 'Andorra'), ('Angola', 'Angola'),
    ...
    seeking_country_five = SelectField(
        u'Select Country',
        choices=[('Afganistan', 'Afghanistan'), ('Albania', 'Albania'),
                 ('Algeria', 'Algeria'), ('American Samoa', 'American Samoa'),
                 ('Andorra', 'Andorra'), ('Angola', 'Angola'),
    ...
    seeking_country_six = SelectField(
        u'Select Country',
        choices=[('Afganistan', 'Afghanistan'), ('Albania', 'Albania'),
                 ('Algeria', 'Algeria'), ('American Samoa', 'American Samoa'),
                 ('Andorra', 'Andorra'), ('Angola', 'Angola'),
    ...
    seeking_country_seven = SelectField(
        u'Select Country',
        choices=[('Afganistan', 'Afghanistan'), ('Albania', 'Albania'),
                 ('Algeria', 'Algeria'), ('American Samoa', 'American Samoa'),
                 ('Andorra', 'Andorra'), ('Angola', 'Angola'),
    ...
    seeking_country_eight = SelectField(
        u'Select Country',
        choices=[('Afganistan', 'Afghanistan'), ('Albania', 'Albania'),
                 ('Algeria', 'Algeria'), ('American Samoa', 'American Samoa'),
                 ('Andorra', 'Andorra'), ('Angola', 'Angola'),
