...
class EventForm(FlaskForm):
    event_title = StringField('Event title', [Length(max=255)])
    event_city = StringField('City', validators=[InputRequired()])
    event_state = StringField('State', validators=[InputRequired()])
    event_type = SelectField(u'Select event type',
                             choices=[('Training', 'Training'),
                                      ('Speed Dating', 'Speed Dating'),
                                      ('Hangout', 'Hangout'),
                                      ('Seminar', 'Seminar')])
    free_or_paid = SelectField(u'Select event type',
